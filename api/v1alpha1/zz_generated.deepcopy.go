...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SubsetType) DeepCopyInto(out *SubsetType) {
	*out = *in
	in.Subset.DeepCopyInto(&out.Subset)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SubsetType.
func (in *SubsetType) DeepCopy() *SubsetType {
	if in == nil {
		return nil
	}
	out := new(SubsetType)
